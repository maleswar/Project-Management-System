...
const ForgotPassword = () => {
  ...
  return (
    <div className="flex items-center justify-center">
      <div className="bg-gray-100 mt-32 w-1/3 rounded-2xl shadow-2xl md:max-w-2xl lg:max-w-6xl p-5">
        <h2 className="font-bold text-2xl sm:text-sm md:text-lg lg:text-2xl ">
          Forgot Password
        </h2>
        <form
