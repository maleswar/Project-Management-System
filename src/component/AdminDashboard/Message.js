...
function Message() {
  ...
  return (
    <div className="flex mx-10 pt-20 gap-5 h-screen">
      {/* Left container */}
      <div className=" w-1/3 rounded-lg shadow-lg border overflow-y-auto p-5 overflow-x-hidden h-[96%]">
        <div>
          <div className="flex">
          ...
          <div className="flex flex-col gap-4  ">
            {teamMembers.map(({ Profile_image, Team_id, Team_name }) => (
              <div
                key={Team_id}
                className="flex items-center gap-4 bg-white border border-gray-400 rounded-lg p-5 w-[350px]"
              >
                <div className="">
                  {Profile_image ? (
                    <img
                ...
                <div>
                  <h6 className="font-semibold text-md">{Team_name}</h6>
                  <button
                ...
                >
                  <div
                    className={`rounded-lg p-2 max-w-xs ${
                      message.Recevier_id != tlid
                        ? "bg-white shadow-xl rounded-lg p-2 max-w-xs"
                        : "bg-white shadow-xl rounded-lg p-2 max-w-xs"
                    }`}
                  >
                    <p>{message.message}</p>
